...
def upgrade():
    ...
    sa.Column('last_version', sa.String(length=100), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('server_nickname')
    )
    ...
    with op.batch_alter_table('owners', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_owners_username'), ['username'], unique=True)
    ...
    sa.ForeignKeyConstraint(['created_by_owner_id'], ['owners.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    with op.batch_alter_table('media_items', schema=None) as batch_op:
        batch_op.create_index('idx_media_items_added_at', ['added_at'], unique=False)
    ...
    with op.batch_alter_table('user_app_access', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_user_app_access_access_expires_at'), ['access_expires_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_user_app_access_discord_user_id'), ['discord_user_id'], unique=True)
        batch_op.create_index(batch_op.f('ix_user_app_access_email'), ['email'], unique=True)
        batch_op.create_index(batch_op.f('ix_user_app_access_username'), ['username'], unique=True)

    op.create_table('app_user_roles',
    sa.Column('app_user_id', sa.Integer(), nullable=False),
    sa.Column('role_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['app_user_id'], ['user_app_access.id'], ),
    ...
    sa.Column('user_app_access_id', sa.Integer(), nullable=True),
    sa.Column('invite_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['invite_id'], ['invites.id'], ),
    sa.ForeignKeyConstraint(['owner_id'], ['owners.id'], ),
    sa.ForeignKeyConstraint(['user_app_access_id'], ['user_app_access.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('discord_username', sa.String(length=255), nullable=True),
    sa.Column('access_expires_at', sa.DateTime(), nullable=True),
    sa.Column('user_raw_data', app.extensions.JSONEncodedDict(), nullable=True),
    sa.Column('stream_raw_data', app.extensions.JSONEncodedDict(), nullable=True),
    sa.ForeignKeyConstraint(['server_id'], ['media_servers.id'], ),
    sa.ForeignKeyConstraint(['used_invite_id'], ['invites.id'], ),
    sa.ForeignKeyConstraint(['user_app_access_id'], ['user_app_access.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('external_user_id', 'server_id', name='_external_user_server_uc'),
    sa.UniqueConstraint('user_app_access_id', 'server_id', name='_user_app_access_server_uc'),
    sa.UniqueConstraint('uuid')
    )
    with op.batch_alter_table('user_media_access', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_user_media_access_user_app_access_id'), ['user_app_access_id'], unique=False)

    op.create_table('media_stream_history',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_app_access_uuid', sa.String(length=36), nullable=True),
    sa.Column('user_media_access_uuid', sa.String(length=36), nullable=True),
    sa.Column('server_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['server_id'], ['media_servers.id'], ),
    sa.ForeignKeyConstraint(['user_app_access_uuid'], ['user_app_access.uuid'], ),
    sa.ForeignKeyConstraint(['user_media_access_uuid'], ['user_media_access.uuid'], ),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('media_stream_history', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_media_stream_history_server_id'), ['server_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_media_stream_history_started_at'), ['started_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_media_stream_history_user_app_access_uuid'), ['user_app_access_uuid'], unique=False)
        batch_op.create_index(batch_op.f('ix_media_stream_history_user_media_access_uuid'), ['user_media_access_uuid'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('media_stream_history', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_media_stream_history_user_media_access_uuid'))
        batch_op.drop_index(batch_op.f('ix_media_stream_history_user_app_access_uuid'))
        batch_op.drop_index(batch_op.f('ix_media_stream_history_started_at'))
        batch_op.drop_index(batch_op.f('ix_media_stream_history_server_id'))

    op.drop_table('media_stream_history')
    with op.batch_alter_table('user_media_access', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_user_media_access_user_app_access_id'))
    ...
    with op.batch_alter_table('user_app_access', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_user_app_access_username'))
        batch_op.drop_index(batch_op.f('ix_user_app_access_email'))
        batch_op.drop_index(batch_op.f('ix_user_app_access_discord_user_id'))
        batch_op.drop_index(batch_op.f('ix_user_app_access_access_expires_at'))
    ...
    with op.batch_alter_table('media_items', schema=None) as batch_op:
        ...
        batch_op.drop_index('idx_media_items_added_at')
    ...
    with op.batch_alter_table('owners', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_owners_username'))
