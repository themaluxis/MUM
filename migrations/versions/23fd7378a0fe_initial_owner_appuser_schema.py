"""initial_owner_appuser_schema

Revision ID: 23fd7378a0fe
Revises: 
Create Date: 2025-08-18 18:19:35.911318
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_app_access_id', sa.Integer(), nullable=False),
    sa.Column('server_id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('media_stream_history', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_media_stream_history_user_app_access_id'), ['user_app_access_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('media_stream_history', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_media_stream_history_user_app_access_id'))
